...
|Run|User|Press Shift| Press up / Press shift| Character run| Medium|None|Run still active until run command is release and stamina is empty|X|
...
|Second attack (kick)|User|Right click|None| Character perform a kick|Medium|None| Medium recovery time|X|
...
|Weak 6|Final Game / Final Test |04/07/2023|Yes|
